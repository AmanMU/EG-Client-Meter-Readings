...
--
-- Dumping data for table `breakdowninformation`
--

LOCK TABLES `breakdowninformation` WRITE;
/*!40000 ALTER TABLE `breakdowninformation` DISABLE KEYS */;
/*!40000 ALTER TABLE `breakdowninformation` ENABLE KEYS */;
UNLOCK TABLES;
